...
/*
 * pad names for "gpio" pins, only seen on the ssd20xd
 * so far.
 */
...
/*
 * not wired up yet as the register offsets are
 * unknown.
 */
#define SSD20XD_PINNAME_GPIO47		"gpio47"
#define SSD20XD_PINNAME_GPIO48		"gpio48"
#define SSD20XD_PINNAME_GPIO85		"gpio85"
#define SSD20XD_PINNAME_GPIO86		"gpio86"
#define SSD20XD_PINNAME_GPIO90		"gpio90"

/*
 * pad names for "ttl" pins, only seen on the ssd20xd
 * so far
 */
...
#define OFF_UART_RX	0x60
#define OFF_UART_TX	0x64
...
#define SSD20XD_GPIO_OFF_GPIO90 0x104
...
#define SSD20XD_TTL_OFFSET_TTL8		0x100
#define SSD20XD_TTL_OFFSET_TTL9		0x104
#define SSD20XD_TTL_OFFSET_TTL10	0x108
#define SSD20XD_TTL_OFFSET_TTL11	0x10c
#define SSD20XD_TTL_OFFSET_TTL12	0x110
#define SSD20XD_TTL_OFFSET_TTL13	0x114
#define SSD20XD_TTL_OFFSET_TTL14	0x118
#define SSD20XD_TTL_OFFSET_TTL15	0x11c
#define SSD20XD_TTL_OFFSET_TTL16	0x120
#define SSD20XD_TTL_OFFSET_TTL17	0x124
#define SSD20XD_TTL_OFFSET_TTL18	0x128
#define SSD20XD_TTL_OFFSET_TTL19	0x12c
#define SSD20XD_TTL_OFFSET_TTL20	0x130
#define SSD20XD_TTL_OFFSET_TTL21	0x134
#define SSD20XD_TTL_OFFSET_TTL22	0x138
#define SSD20XD_TTL_OFFSET_TTL23	0x13c
#define SSD20XD_TTL_OFFSET_TTL24	0x140
#define SSD20XD_TTL_OFFSET_TTL25	0x144
#define SSD20XD_TTL_OFFSET_TTL26	0x148
#define SSD20XD_TTL_OFFSET_TTL27	0x14c
