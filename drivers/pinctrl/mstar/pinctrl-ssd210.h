...
#define REG_SSD210_PWM2		0x194
#define SHIFT_SSD210_PWM2	8
#define WIDTH_SSD210_PWM2	4
#define MASK_SSD210_PWM2	MAKEMASK(SSD210_PWM2)

#define REG_SSD210_PWM3		0x194
#define SHIFT_SSD210_PWM3	12
#define WIDTH_SSD210_PWM3	4
#define MASK_SSD210_PWM3	MAKEMASK(SSD210_PWM3)

#define REG_SSD210_SDIO		0x19c
#define SHIFT_SSD210_SDIO	8
#define WIDTH_SSD210_SDIO	2
#define MASK_SSD210_SDIO	MAKEMASK(SSD210_SDIO)

#define REG_SSD210_SPI0		0x1a0
#define SHIFT_SSD210_SPI0	0
#define WIDTH_SSD210_SPI0	3
#define MASK_SSD210_SPI0	MAKEMASK(SSD210_SPI0)

#define REG_SSD210_SPI1		0x1a0
#define SHIFT_SSD210_SPI1	8
#define WIDTH_SSD210_SPI1	4
#define MASK_SSD210_SPI1	MAKEMASK(SSD210_SPI1)

#define REG_SSD210_UART1	0x1b4
#define SHIFT_SSD210_UART1	4
#define WIDTH_SSD210_UART1	4
#define MASK_SSD210_UART1	MAKEMASK(SSD210_UART1)

#define REG_SSD210_UART2	0x1b4
#define SHIFT_SSD210_UART2	8
#define WIDTH_SSD210_UART2	3
#define MASK_SSD210_UART2	MAKEMASK(SSD210_UART1)
