...
static const int ssd20xd_i2c_mode1_pins[] = {
	PIN_SSD20XD_GPIO2,
	PIN_SSD20XD_GPIO3,
};

static const int ssd20xd_i2c_mode3_pins[] = {
	PIN_SSD20XD_FUART_CTS,
	PIN_SSD20XD_FUART_RTS,
};

static const int ssd20xd_i2c_mode4_pins[] = {
	PIN_SSD20XD_TTL22,
	PIN_SSD20XD_TTL23,
};

static const int ssd20xd_i2c_mode5_pins[] = {
	PIN_SSD20XD_SD_CLK,
	PIN_SSD20XD_SD_CMD,
};
...
static const struct msc313_pinctrl_group ssd20xd_pinctrl_groups[] = {
	...
	SSD20XD_PINCTRL_GROUP(I2C1_MODE1, i2c_mode1),
	SSD20XD_PINCTRL_GROUP(I2C1_MODE3, i2c_mode3),
	SSD20XD_PINCTRL_GROUP(I2C1_MODE4, i2c_mode4),
	SSD20XD_PINCTRL_GROUP(I2C1_MODE5, i2c_mode5),
};
...
/* mux pin groupings */
static const int ssc8336n_i2c0_pins[] = {
	PIN_SSC8336N_I2C0_SCL,
	PIN_SSC8336N_I2C0_SDA,
};
static const int ssc8336n_i2c1_pins[] = {
...
static const int ssc8336n_sd_pins[] = {
	PIN_SSC8336N_SD_CLK,
	PIN_SSC8336N_SD_CMD,
	PIN_SSC8336N_SD_D0,
	PIN_SSC8336N_SD_D1,
...
static const int ssc8336n_fuart_pins[] = {
...
int mstar_set_mux(struct pinctrl_dev *pctldev, unsigned int func,
			   unsigned int group)
{
